import random
drinks = ["vodka", "tequila", "rum", "gin", "beer", "wine", "limoncello", "mezcal"]
try:
    ...
    if age < 0 or age > 140:
        ...
        print("You are not allowed to drink in the USA or UAE. You can not play the awesome drinking game.")
    else:
